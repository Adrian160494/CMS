...
class BaneryModel extends BaseModelService {
    protected static $table = "cms_bannery";

    public function getBaneryByProject($id_projektu){
    ...
    {
        return parent::selectWhere($id,self::$table); // TODO: Change the autogenerated stub
    }
}